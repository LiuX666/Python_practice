...
! function(t, e) {
    ...
    function y(t, e) {
        ...
        if (tt(t))
            ...
            for (o in t) z.call(t, o) && e.call(t[o], t[o], o);
        return t
    }
    ...
    function j(t, e, n, o) {
        var r = t[n],
            i = [];
        if (E(r) && "" !== r)
            if ("string" == typeof r || "number" == typeof r || "boolean" == typeof r) r = r.toString(), o && "*" !== o && (r = r.substring(0, parseInt(o, 10))), i.push(P(e, r, O(e) ? n : null));
    ...
    function A(t, e, n) {
        var o, r = tt(e),
            i = h(e);
        y(e, function(e, u) {
            o = f(e) || tt(e), n && (u = n + "[" + (i || o ? u : "") + "]"), !n && r ? t.add(e.name, e.value) : o ? A(t, e, u) : t.add(u, e)
        })
    }
    ...
    var G = !1,
        ...
        Z = function(t) {
            V = t.util, G = t.config.debug || !t.config.silent
        },
        tt = Array.isArray,
        et = Object.assign || g,
        nt = function(t, e) {
    ...
    $.options = {
        ...
        root: null,
        params: {}
    }, $.transforms = [rt, ot, nt], $.params = function(t) {
        var e = [],
    ...
    var it = function(t) {
        ...
        ut = Y && "withCredentials" in new XMLHttpRequest,
        st = function(t, e) {
            if (Y) {
        ...
        at = function(t, e) {
            d(t.body) ? t.headers.delete("Content-Type") : (f(t.body) || tt(t.body)) && (t.emulateJSON ? (t.body = $.params(t.body), t.headers.set("Content-Type", "application/x-www-form-urlencoded")) : t.body = JSON.stringify(t.body)), e(function(t) {
                return Object.defineProperty(t, "data", {
                    ...
                    if (0 === n.indexOf("application/json") || R(e)) try {
                        t.body = JSON.parse(e)
                    } catch (e) {
                        t.body = null
                    } else t.body = e;
        ...
        lt = "undefined" != typeof Blob && "undefined" != typeof FileReader,
        mt = function(t) {
            return new e(function(e) {
    ...
    bt.prototype.has = function(t) {
        ...
        var n = this.getAll(t);
        n.length ? n.push(i(e)) : this.set(t, e)
    ...
    var wt = function(t) {
        this.body = null, this.params = {}, et(this, t, {
